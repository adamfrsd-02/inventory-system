                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 text-primary">Page : Dashboard / <b>Material List</b></h6>
                        ...
                        <div class="card-body">
                            <div style="justify-content: space-between; display: flex;">
                                ...
                                <a data-toggle="modal" data-target="#addModal" class="my-auto"
                                    style="cursor:pointer; text-decoration: none">+ Add Material</a>
                            </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h5 class="modal-title" id="exampleModalLabel">Add Material Details</h5>
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <form method="post" action="action/add_material.php">
                                                    <div class="form-group">
                                                        <label for="my-input">Lego Number</label>
                                                        <input id="my-input" class="form-control" type="text"
                                                            name="lego_no">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="my-input">Part Number</label>
                                                        <input id="my-input" class="form-control" type="text"
                                                            name="part_no">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="my-input">SS Code</label>
                                                        <input id="my-input" class="form-control" type="text"
                                                            name="ss_code">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="my-input">Model</label>
                                                        <input id="my-input" class="form-control" type="text"
                                                            name="model">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="my-input">Part Name</label>
                                                        <input id="my-input" class="form-control" type="text"
                                                            name="part_name">
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="my-input">Lab Test Date</label>
                                                        <input id="my-input" class="form-control" type="datetime-local"
                                                            name="lab_test_date">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="my-input">Expiration Lab Test Date</label>
                                                        <input id="my-input" class="form-control" type="datetime-local"
                                                            name="expired_time">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="my-input">Chemical Status</label>
                                                        <select id="my-input" class="form-control" type="text"
                                                            name="psh3_chemical">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="my-input">Accessibility Status</label>

                                                        <select class="form-control" name="access_status"
                                                            for="my-input">
                                                            <option value="" disabled selected>please choose . . .
                                                            </option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select class="form-control mb-2" name="material_type"
                                                            for="my-input">
                                                            <option value="" disabled selected>please choose . . .
                                                            </option>
                                                            <?php
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered text-center" id="myTable" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        $query = mysqli_query($koneksi,"SELECT * FROM tb_material LEFT JOIN tb_material_type ON tb_material.id_material_type=tb_material_type.id_type");
                                        ...
                                        ?>
                                        <tr>
                                            <td><?= $data["lego_design_no"]?></td>
                                            <td><?= $data["model_name"]?></td>
                                            <td><?= $data["part_name"]?></td>
                                            <td><?= $data["supplier"]?></td>
                                            <td><?= $data["lab_test_date"]?></td>
                                            <td><?= $data["psh3_chemical"]?></td>
                                            <!-- modal detail button -->
                                            <td><a class="text-primary" data-toggle="modal"
                                                    data-target="#detail<?= $data["id_material"]?>"
                                        ...
                                        <!-- Modal Detail -->
                                        <div class="modal fade " id="detail<?= $data['id_material']?>" tabindex="-1"
                                            ...
                                            <div class="modal-dialog modal-lg" role="document">
                                                <div class="modal-content pt-2">
                                                        ...
                                                        <div class="row">
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        value="<?= $data["lego_design_no"]?>" readonly>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">Part No.</label>
                                                                    <input type="text" class="form-control"
                                                                        value="<?= $data["part_number"]?>" readonly>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">SS Code</label>
                                                                    <input type="text" class="form-control"
                                                                        value="<?= $data["ss_code"]?>" readonly>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">Model</label>
                                                                    <input type="text" class="form-control"
                                                                        value="<?= $data["model_name"]?>" readonly>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">Part Name</label>
                                                                    <input type="text" class="form-control"
                                                                        value="<?= $data["part_name"]?>" readonly>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">Supplier</label>
                                                                    <input type="text" class="form-control"
                                                                        value="<?= $data["supplier"]?>" readonly>
                                                                </div>
                                                            ...
                                                            <div class="col-md-4">
                                                                ...
                                                                <div class="form-group">
                                                                    ...
                                                                    <input type="text" class="form-control"
                                                                        value="<?= $data["lab_test_date"]?>" readonly>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">Expiration Lab Test Date</label>
                                                                    <input type="text" class="form-control"
                                                                        value="<?= $data["expired_time"]?>" readonly>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">Chemical Status</label>
                                                                    <input type="text" class="form-control"
                                                                        value="<?= $data["psh3_chemical"]?>" readonly>
                                                                </div>
                                                                <div class="form-group">
                                                                    <label for="">Accessibility Status</label>
                                                                    <input type="text" class="form-control"
                                                                        value="<?= $data["accesibility_status"]?>"
                                                                        readonly>
                                                                </div>
                                                            </div>
                                                            <div class="col-md-4">
                                                    ...
                                                    <div class="modal-footer">
                                                        <a href="action/delete_material.php?id_material=<?= $data['id_material']?>"
                                                            type="button" class="btn btn-danger px-5 py-2"><i
                                                                class="fas fa-trash"></i>
                                                            Remove</a>
                                                        <a href="edit_material.php?id_material=<?= $data['id_material']?>"
