...
$query = mysqli_query($koneksi,"SELECT * FROM tb_material_type WHERE id_type='$id'");
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <div class="container">
                            <form action="action/edit_type.php" method="post">
                                <input type="hidden" name="id_material_type" value="<?= $id;?>">
                                <div class="row py-4">
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="supplier" value="<?= $data["supplier_name"] ?>" class="form-control">
                                        </div>
