        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800"><b>Document List</b></h1>
                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 text-primary">Page : Dashboard / <b>Document List</b></h6>
                        ...
                        <div class="card-body">
                            <div style="justify-content: space-between; display: flex; margin-bottom: 10px">
                                ...
                                <a data-toggle="modal" data-target="#addModal" class="my-auto"
                                    style="cursor:pointer; text-decoration: none">+ Upload Document</a>
                            </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered modal-lg" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="container">
                                                <form method="post" action="action/add_document.php" enctype="multipart/form-data">
                                                    <div class="form-group">
                                                        <label for="my-input">Document Title</label>
                                                        <input id="my-input" class="form-control" type="text"
                                                            name="title">
                                                    </div>
                                                    <div class="form-group">
                                                        <label for="exampleFormControlFile1">Choose Document</label>
                                                        <input type="file" class="form-control-file"
                                                            id="exampleFormControlFile1" name="dokumen">
                                                    </div>
                                                    <small>Allowed extension .pdf .docx .doc</small>
                            ...
                            <div class="table-responsive">
                                <table class="table table-bordered text-center" id="myTable" width="100%">
                                    ...
                                    <tbody>
                                        ...
                                        $query = mysqli_query($koneksi,"SELECT * FROM tb_document LEFT JOIN tb_user ON tb_document.id_user=tb_user.id_user LEFT JOIN tb_user_profile ON tb_user.id_user_profile=tb_user_profile.id_user_profile");
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a class="btn btn-primary mr-2" 
                                                    href="document/<?= $data["document_name"]?>"
                                                    style="text-decoration:none; cursor:pointer"><i
                                                class="fas fa-eye"></i> Download</a> 
                                                <a class="btn btn-danger <?= ($_SESSION['id_user'] != $data['id_user'] ? 'd-none' : '')?>" 
                                                    href="action/delete_document.php?id=<?= $data["id_document"]?>"
                                                    style="text-decoration:none; cursor:pointer"><i
