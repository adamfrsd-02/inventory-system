                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                ...
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    ...
                                                    $query = mysqli_query($koneksi, "SELECT * FROM tb_material WHERE  accesibility_status='Accessible'");
                                        ...
                                        <div class="row no-gutters align-items-center">
                                            <div class="col mr-2">
                                                <div class="text-xs font-weight-bold text-warning text-uppercase mb-1">
                                                    Item(Not Accesible)</div>
                                                <div class="h5 mb-0 font-weight-bold text-gray-800">
                                                    <?php
                    
                                                    $query = mysqli_query($koneksi, "SELECT * FROM tb_material WHERE  accesibility_status='Not Accessible'");
                                                    $jumlah = mysqli_num_rows($query);
                                                    echo $jumlah;
